...
#[Fillable(['no', 'customer_id', 'document_type', 'posting_date', 'due_date', 'customer_posting_group_id', 'number_series_code', 'status', 'share_subscription_id', 'share_billing_run_id'])]
