...
class DatabaseSchemaTest extends TestCase
{
    ...
    public function test_business_central_tables_are_created(): void
    {
        $tables = [
            ...
            'bus_members' => ['no', 'user_id', 'identity_no', 'identity_type', 'phone', 'member_status', 'is_chakama', 'is_sbf', 'customer_no', 'vendor_no', 'type', 'member_id', 'name', 'email', 'date_of_birth', 'relationship', 'contact_preference'],
